#!/usr/bin/env python3
"""
Distro detection and package-name resolution for the MasterR installer. This is
...
def _check_token_mirrors():
    ...
    module) and masterr-update.py (ships standalone on user boxes). Nothing at
    ...
    engine_path = os.path.join(root, "configs", "hypr", "scripts", "masterr-update.py")
    spec = importlib.util.spec_from_file_location("_masterr_update", engine_path)
