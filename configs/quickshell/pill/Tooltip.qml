...
Item {
    ...
    implicitHeight: bubble.height + pointerH
    width: implicitWidth
    ...
    Rectangle {
        ...
        width: Math.max(titleText.implicitWidth, (descText.visible ? descText.implicitWidth : 0)) + (descText.visible ? 24 : 18) * root.s
        height: column.implicitHeight + (descText.visible ? 14 : 10) * root.s
        radius: (descText.visible ? 9 : 7) * root.s
        border.width: 1
