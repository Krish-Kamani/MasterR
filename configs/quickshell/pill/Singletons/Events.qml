 ...
 * flags (~/.local/state/masterr/events.json). The in-memory `events` is the
...
Singleton {
    ...
    readonly property string stateDir: (Quickshell.env("XDG_STATE_HOME") || (Quickshell.env("HOME") + "/.local/state")) + "/masterr"
