...
Item {
    ...
    Text {
        ...
        text: root.kanji
        color: field.activeFocus ? Theme.vermLit : Theme.dim
    ...
    Rectangle {
        ...
        height: field.activeFocus ? 1.5 * root.s : 1
        color: field.activeFocus ? Theme.vermLit : Theme.faint
        opacity: field.activeFocus ? 0.85 : 0.2
