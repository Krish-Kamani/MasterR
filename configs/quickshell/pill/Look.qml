...
SettingsSurface {
    ...
    rows: {
        ...
        if (dockGrp.open) {
            r.push({ item: dockEnRow, kind: "toggle", get: function () { return Flags.dockEnable; }, set: function (v) { Flags.dockEnable = v; } });
            if (Flags.dockEnable) {
                r.push({ item: dockPinRow, kind: "toggle", get: function () { return Flags.dockPinned; }, set: function (v) { Flags.dockPinned = v; } });
                r.push({ item: dockHoverRow, kind: "toggle", get: function () { return Flags.dockHoverToReveal; }, set: function (v) { Flags.dockHoverToReveal = v; } });
            }
        }
        return r;
    }
    ...
    Column {
        ...
        Column {
            ...
            Group { id: dockGrp; title: "Dock"

            FieldRow {
                id: dockEnRow
                label: "Bottom dock"
                caption: "Show app dock at the bottom of the screen"
                LinkToggle {
                    s: root.s
                    on: Flags.dockEnable
            ...
            FieldRow {
                id: dockPinRow
                label: "Pin dock"
                caption: "Keep dock always visible and reserve desktop space"
                collapsed: !Flags.dockEnable
                LinkToggle {
                    s: root.s
                    on: Flags.dockPinned
                    onToggled: Flags.dockPinned = !Flags.dockPinned
                }
            }
            ...
            FieldRow {
                ...
                collapsed: !Flags.dockEnable || Flags.dockPinned
                LinkToggle {
                    s: root.s
