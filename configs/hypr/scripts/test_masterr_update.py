#!/usr/bin/env python3
"""
Self-test for masterr-update.py against throwaway git repos in a temp dir. No
...
spec = importlib.util.spec_from_file_location("masterr_update", HERE / "masterr-update.py")
