...
icon_dir="$data_home/masterr/appimages"
registry="$data_home/masterr/appimages.json"
...
install_appimage() {
	...
	local df_out="$desktop_dir/masterr-$slug.desktop"
	{
		echo "[Desktop Entry]"
